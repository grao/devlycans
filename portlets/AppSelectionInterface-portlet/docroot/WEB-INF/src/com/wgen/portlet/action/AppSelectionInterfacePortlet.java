...
public class AppSelectionInterfacePortlet extends MVCPortlet {
	...
	/*	AppsData fullwind = new AppsData();
		...
		fullwind.setDescription("Dash Board in Full Window");
		...
		iframe.setDescription("Dash Board in Iframe page");
		...
		iframe1.setDescription("Wgen Mail in Iframe page");
		...
		wsrp.setDescription("Show time in WSRP page");
		...
		wsrp1.setDescription("Book Mark in WSRP page");
