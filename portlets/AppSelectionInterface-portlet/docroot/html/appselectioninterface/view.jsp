...
<div class="" id="app_list_box">
  ...
  <ul class="right_menu">
   ...
   <%i++; %>
    ...
    <span class="r_menu_title"><img src="${app.image_url }" alt="app_logo"></img></span>
		<span class="r_menu_title"> <c:out value="${app.name}"></c:out></span>
    <div class="clr"></div>
    <span class="r_menu_dis"><c:out value="${app.description}"></c:out></span>
	</a>
   <%-- 	<span class="r_menu_title"> <c:out value="${app.name}"></c:out></span>
    <div class="clr"></div>
    <span class="r_menu_dis"><c:out value="${app.description}"></c:out></span>
