		...
		if(Validator.isNotNull(header)){
			...
			try{
				...
				if(currUrl.contains("web/guest/admin")){
					headerData = headerData.replace("[$IS_ADMIN_PAGE$]","<li><a href=\"/portal/web/guest/home\">Home</a></li>");
					//headerData = headerData.replace("[$SLI_TEXT$]","<a href=\"/portal/web/guest/home\" style=\"font-weight:normal;\"><span>State Department of Education</span></a>");
				}else{
					headerData = headerData.replace("[$IS_ADMIN_PAGE$]","");
					//headerData = headerData.replace("[$SLI_TEXT$]","<a href=\"/portal/web/guest/home\" style=\"font-weight:normal;\"><span>SLI Portal</span></a>");
				}
				
				if(isAdmin){
					headerData = headerData.replace("[$ADMIN_PAGE$]", "<li class=\"last_item\"><a href=\"/portal/web/guest/admin\">Admin</a></li></li>");
					headerData = headerData.replace("[$ADMIN_PAGES$]", "<li class=\"last_item\"><a href=\"/portal/web/guest/admin\" class=\"menulink\">Admin</a></li>");
				}else{
	...
	public String getFooter(boolean isAdmin,String fullName) throws SystemException {
		...
		if(Validator.isNotNull(footer)){
			...
			try{
				...
				if(isAdmin){
					footerData = footerData.replace("[$ADMIN_PAGE$]", "<li><a href=\"/portal/web/guest/admin\">Admin</a></li></li>");
				}else{
