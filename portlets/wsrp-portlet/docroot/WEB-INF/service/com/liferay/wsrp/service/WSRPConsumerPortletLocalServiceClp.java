...
public class WSRPConsumerPortletLocalServiceClp
	...
	public WSRPConsumerPortletLocalServiceClp(ClassLoaderProxy classLoaderProxy) {
		...
		_getWSRPConsumerPortletByConsumerIdMethodKey31 = new MethodKey(_classLoaderProxy.getClassName(),
				"getWSRPConsumerPortletByConsumerId", long.class);
	}
	...
	public com.liferay.wsrp.model.WSRPConsumerPortlet getWSRPConsumerPortletByConsumerId(
		long wsrpConsumerId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		Object returnObj = null;

		MethodHandler methodHandler = new MethodHandler(_getWSRPConsumerPortletByConsumerIdMethodKey31,
				wsrpConsumerId);
	...
	private MethodKey _getWSRPConsumerPortletByConsumerIdMethodKey31;
}