...
public class WSRPConsumerPortletLocalServiceUtil {
	...
	*/
	...
	public static com.liferay.wsrp.model.WSRPConsumerPortlet getWSRPConsumerPortletByConsumerId(
		long wsrpConsumerId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getWSRPConsumerPortletByConsumerId(wsrpConsumerId);
	}
