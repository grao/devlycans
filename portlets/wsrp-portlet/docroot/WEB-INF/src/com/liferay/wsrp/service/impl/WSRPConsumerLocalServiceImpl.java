...
public class WSRPConsumerLocalServiceImpl
	...
	public WSRPConsumer getWSRPConsumerByURL(String url)
	throws PortalException, SystemException {   
		
		WSRPConsumer wsrpConsumer = wsrpConsumerPersistence.fetchByConsumerURL(url);
		if (Validator.isNull(wsrpConsumer)) {
			throw new NoSuchConsumerException(
				"No WSRP consumer exists with uuid " + url);
		}
		else {
			return wsrpConsumer;
		}
