...
public class WSRPConsumerPortletLocalServiceImpl
	...
	public WSRPConsumerPortlet getWSRPConsumerPortletByConsumerId(
			long wsrpConsumerId)
		throws PortalException, SystemException {

		List<WSRPConsumerPortlet> wsrpConsumerPortlet= wsrpConsumerPortletPersistence.findByWsrpConsumerId(wsrpConsumerId);
		
		if (wsrpConsumerPortlet.isEmpty()) {
			throw new NoSuchConsumerPortletException(
				"No WSRP consumer portlet exists with id " + wsrpConsumerId);
		}
		else {
			return wsrpConsumerPortlet.get(0);
		}
	}
