...
public class WSRPConsumerPersistenceImpl extends BasePersistenceImpl<WSRPConsumer>
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_COMPANYID = new FinderPath(WSRPConsumerModelImpl.ENTITY_CACHE_ENABLED,
			...
			new String[] { Long.class.getName() });
	public static final FinderPath FINDER_PATH_FETCH_BY_CONSUMERURL = new FinderPath(WSRPConsumerModelImpl.ENTITY_CACHE_ENABLED,
			WSRPConsumerModelImpl.FINDER_CACHE_ENABLED, WSRPConsumerImpl.class,
			FINDER_CLASS_NAME_ENTITY, "fetchByConsumerURL",
			new String[] { String.class.getName() },
			WSRPConsumerModelImpl.URL_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_CONSUMERURL = new FinderPath(WSRPConsumerModelImpl.ENTITY_CACHE_ENABLED,
			WSRPConsumerModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByConsumerURL",
			new String[] { String.class.getName() });
	...
	public void cacheResult(WSRPConsumer wsrpConsumer) {
		...
		FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_CONSUMERURL,
			new Object[] { wsrpConsumer.getUrl() }, wsrpConsumer);
	...
	public void clearCache(WSRPConsumer wsrpConsumer) {
		...
		clearUniqueFindersCache(wsrpConsumer);
	}
	...
	protected void clearUniqueFindersCache(WSRPConsumer wsrpConsumer) {
		FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_CONSUMERURL,
			new Object[] { wsrpConsumer.getUrl() });
	}
	...
	public WSRPConsumer updateImpl(
		...
		if (isNew) {
			...
			if ((wsrpConsumerModelImpl.getColumnBitmask() &
					FINDER_PATH_FETCH_BY_CONSUMERURL.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						wsrpConsumerModelImpl.getOriginalUrl()
					};

				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_CONSUMERURL,
					args);
				FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_CONSUMERURL,
					args);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public WSRPConsumer findByConsumerURL(String url)
		throws NoSuchConsumerException, SystemException {
		WSRPConsumer wsrpConsumer = fetchByConsumerURL(url);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public WSRPConsumer fetchByConsumerURL(String url)
		throws SystemException {
		return fetchByConsumerURL(url, true);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public WSRPConsumer fetchByConsumerURL(String url, boolean retrieveFromCache)
		throws SystemException {
		...
		if (retrieveFromCache) {
			result = FinderCacheUtil.getResult(FINDER_PATH_FETCH_BY_CONSUMERURL,
					finderArgs, this);
		}
		...
		if (result == null) {
			...
			if (url == null) {
				query.append(_FINDER_COLUMN_CONSUMERURL_URL_1);
			}
			else {
				if (url.equals(StringPool.BLANK)) {
					query.append(_FINDER_COLUMN_CONSUMERURL_URL_3);
				}
				else {
					query.append(_FINDER_COLUMN_CONSUMERURL_URL_2);
				}
			}
			...
			try {
				...
				if (list.isEmpty()) {
					...
					wsrpConsumer = list.get(0);

					cacheResult(wsrpConsumer);

					if ((wsrpConsumer.getUrl() == null) ||
							!wsrpConsumer.getUrl().equals(url)) {
						FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_CONSUMERURL,
							finderArgs, wsrpConsumer);
					}
				}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void removeByConsumerURL(String url)
		throws NoSuchConsumerException, SystemException {
		WSRPConsumer wsrpConsumer = findByConsumerURL(url);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int countByConsumerURL(String url) throws SystemException {
		Object[] finderArgs = new Object[] { url };

		Long count = (Long)FinderCacheUtil.getResult(FINDER_PATH_COUNT_BY_CONSUMERURL,
				finderArgs, this);
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_CONSUMERURL,
					finderArgs, count);
	...
	private static final String _FINDER_COLUMN_CONSUMERURL_URL_1 = "wsrpConsumer.url IS NULL";
	private static final String _FINDER_COLUMN_CONSUMERURL_URL_2 = "wsrpConsumer.url = ?";
	private static final String _FINDER_COLUMN_CONSUMERURL_URL_3 = "(wsrpConsumer.url IS NULL OR wsrpConsumer.url = ?)";
